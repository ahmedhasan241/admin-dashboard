<template lang="pug">
.dashboard
  h3.main-title Overview
  div.mt-4
    div.flex.flex-wrap.mx-0
      div.dashboard-card
        div.dashboard-card-contain
          div.p-3.mx-2.bg-indigo-600.bg-opacity-75.rounded-full
            svg.w-8.h-8.text-white(viewBox="0 0 28 30", fill="none", xmlns="http://www.w3.org/2000/svg")
          ...
          div.card-contain
            h4.card-title 8,282
            div.card-description New Users

      div.dashboard-card
        div.dashboard-card-contain
          div.p-3.bg-blue-600.bg-opacity-75.rounded-full
            svg.w-8.h-8.text-white(viewBox="0 0 28 28", fill="none", xmlns="http://www.w3.org/2000/svg")
          ...
          div.card-contain
            h4.card-title 200,521
            div.card-description Total Orders

      div.dashboard-card
        div.dashboard-card-contain
          div.p-3.bg-pink-600.bg-opacity-75.rounded-full
            svg.w-8.h-8.text-white(viewBox="0 0 28 28", fill="none", xmlns="http://www.w3.org/2000/svg")
          ...
          div.card-contain
            h4.card-title 215,542
            div.card-description Available Products
